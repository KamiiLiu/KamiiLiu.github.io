        ...
        .then(res => {
            ...
            maps.forEach((e,i)=>{
                ...
                if(i==0){
                    ...
                    var marker = L.marker([school.Lat, school.Long],{icon: blueIcon}).addTo(map)
                    .bindPopup(`${school.School}<br>學生人數：${school.Number}<br>學校性質：${school.Money}`)
                    .closePopup()}else if(school.His[i]&&school.His[i-1]){
...
// var map1 = L.map('b1').setView([51.505, -0.09], 13);
// L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
//     maxZoom: 19,
//     attribution: '1895-1922'
// }).addTo(map1);
// var map2 = L.map('b2').setView([51.505, -0.09], 13);
// L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
//     maxZoom: 19,
//     attribution: '1922-1945'
// }).addTo(map2);
// var map3 = L.map('b3').setView([51.505, -0.09], 13);
// L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
//     maxZoom: 19,
//     attribution: '1945-1967'
// }).addTo(map3);
// var map4 = L.map('b4').setView([51.505, -0.09], 13);
// L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
//     maxZoom: 19,
//     attribution: '1967-1994'
// }).addTo(map4);
// var map5 = L.map('b5').setView([51.505, -0.09], 13);
// L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
//     maxZoom: 19,
//     attribution: '1994-2022'
// }).addTo(map5);

// schoolnumber.forEach(e=>{ 
//     let dict =e.school.substring(0,3);
//     let money =e.school.substring(4,6);
//     e["dict"]=dict;
//     e["money"]=money;
//     e.school=e.school.replace(`${dict}`,"").trim();
//     let a=location.filter((m)=>m.school==e.school)
//     e["lat"]=a[0].Lat
//     e["long"]=a[0].Long
// })
// schoolnumber